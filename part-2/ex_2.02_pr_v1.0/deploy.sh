...
docker rmi tryfonm/todo-frontend:v2.02
docker rmi tryfonm/todo-backend:v2.02

docker build -t tryfonm/todo-frontend:v2.02 -f todo-frontend.Dockerfile .
docker push tryfonm/todo-frontend:v2.02
docker build -t tryfonm/todo-backend:v2.02 -f todo-backend.Dockerfile .
docker push tryfonm/todo-backend:v2.02
